...
uint256 hashGenesisBlock("0x9b76205b38a6a6770c8ddfeb756a165b24a65796c2045e11bd4a008c7c5b596b");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Insanity: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Insanity Signed Message:\n";
...
{
    // Insanity: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight == 1){
        nSubsidy = nSubsidy * 239200 * 5  / 100 / 1;
     }

    nSubsidy >>= (nHeight / 113636);


    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 43200;
static const int64 nTargetSpacing = 43200;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Insanity: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Insanity: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Insanity: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9b76205b38a6a6770c8ddfeb756a165b24a65796c2045e11bd4a008c7c5b596b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1416180217;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2089850299;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("InsanityMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("InsanityMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running Insanity with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("InsanityMiner terminated\n");
        throw;
    }
}
